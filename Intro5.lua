...
function Intro5:keyreleased(key)
	if time > 2 then
		switchTo(StageIntro)
	end
end

function Intro5:keypressed(key)
end

function Intro5:stop()
	time = 0
	changed = 0
	self.pos = -(self.bg:getHeight() - height)
	self.script_pos = 1
